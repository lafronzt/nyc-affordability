...
shortDefinition: "The HUD-published median household income for the NYC metro area, used to set eligibility and rent caps on every affordable housing listing."
metaDescription: "AMI (Area Median Income) is the HUD benchmark income NYC uses to set eligibility and rent limits for Housing Connect. See the FY2026 table by household size and a worked example."
updated: "2026-08-12"
...
Source: HUD FY2026 Income Limits, New York HMFA.
