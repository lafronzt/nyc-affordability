---
title: "How NYC Co-op Board Approval and the Board Package Work"
...
sources:
  ...
  - label: "CooperatorNews New York — The Board Approval Process"
    url: "https://cooperatornews.com/article/the-board-approval-process"
...
cta:
  ...
  label: "Open the Co-op Calculator"
  href: "/coop/"
---

## Why co-op approval is a separate process from mortgage approval
...
- **Proof of funds** for the down payment and any required post-closing reserves. See our [reserve requirements guide](/guides/coop-board-reserve-requirements/) for how boards calculate that number and what counts as liquid.
...
- **Debt-to-income ratio** — the long-standing NYC standard caps board DTI around **28%** of gross monthly income going to housing costs (maintenance plus mortgage P&I), though this varies by building. See our [income-needed-to-buy guide](/guides/income-needed-to-buy-nyc-apartment/) for exactly how this compares to a condo lender's looser 43% standard.
